...
NOTE: Les stages avec rapports et soutenances confidentiels sont à envoyer par email à {responsable} avec [STAGE CONFIDENTIEL] dans le sujet et les fichiers nommés comme ci-dessus.
----
